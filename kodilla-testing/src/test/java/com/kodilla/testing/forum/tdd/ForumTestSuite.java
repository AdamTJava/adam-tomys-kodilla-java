...
public class ForumTestSuite {
    ...
    class TestPosts {
        ...
        void testGetPost() {
            ...
            //When
            ForumPost testingPost = forumUser.getPost(0);

            //Then
            Assertions.assertEquals(thePost, testingPost);
        }
    ...
    class TestComments {
        ...
        void testGetComment() {
            ...
            //When
            ForumComment testingComment = forumUser.getComment(0);

            //Then
            Assertions.assertEquals(theComment, testingComment);
        }
